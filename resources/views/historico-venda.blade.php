        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 p-4 bg-white dark:bg-gray-800 shadow-md sm:rounded-lg">
                <div class="md:flex md:items-end md:justify-between">
                    <form action="{{ route('historico-vendas.index') }}" method="GET"
                    ...
                    <form action="{{ route('historico-vendas.pdf') }}" method="GET" target="_blank"
            ...
            <div class="flex flex-col gap-4">
                            ...
                            <div class="p-4 sm:p-6 flex-1 flex flex-col justify-between text-gray-900 dark:text-gray-100">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-2">
                                        Vendido por: <span class="font-medium">{{ $product->seller->name }}</span>
                                    </p>
                                    <p class="text-sm text-gray-600 dark:text-gray-400">
                                        Comprado por: <span class="font-medium">{{ $sale->buyer->name }}</span>
                                    </p>
                                </div>
                                <div class="flex justify-between items-center mt-3">
                                    <p class="text-blue-600 dark:text-blue-400 font-bold text-lg">
                                        R$
                                        {{ number_format($product->pivot->price_at_sale * $product->pivot->quantity, 2, ',', '.') }}
                                    </p>
                ...
                @empty
                    <div class="p-6 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <p class="text-gray-500 dark:text-gray-400 text-center">Nenhuma venda encontrada.</p>
                    </div>
                @endforelse
            </div>
